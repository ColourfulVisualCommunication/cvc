...
const DEFAULT_CONTENT = {
  ...
  desktopTitleFont: { fontFamily: "var(--font-heading)", fontSize: 144, fontWeight: 700, lineHeight: 0.86, letterSpacing: "-0.075em", textAlign: "left" },
  compactTitleFont: { fontFamily: "var(--font-heading)", fontSize: 72, fontWeight: 700, lineHeight: 0.9, letterSpacing: "-0.065em", textAlign: "left" },
  titleCenterGap: 32,
  centerText: "",
  centerTextWidth: 220,
  compactTextGap: 28,
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 10, transformStyle: "preserve-3d" }}>
          {projectItems.map((item, index) => {
            ...
            const flattenEnd = Math.min(0.75 + index * 0.009, 0.99);
